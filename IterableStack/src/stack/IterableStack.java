 ...
 * @param <Item>
 */
public class IterableStack<Item>  implements Iterable<Item>{// a los genericos le digo que tipo de dato quiero utilizar en la estructura de datos, donde dice item, se va a reemplazar por el tipo que yo le diga
 ...
 */
    ...
    @Override
    public Iterator<Item> iterator() { //se debe llamar iterator poqurque asi se llama el metodo astracto de la interface
        return new Iterador (); //debe retornar siempre un iterador
    }
