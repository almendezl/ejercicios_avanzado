...
public class Controlador extends JFrame implements KeyListener {
    ...
    private long goal;
    private final int tiempoDemora = 40;
    ...
    private void inicializoObjetos() {
        ...
        auto.tamanioAuto();
        iconosS();
        senal1 = new SenalT(iconS[(int)(Math.random()*(iconS.length-1))]);
        senal1.nuevaSenal();
        senal2 = new SenalT(iconS[(int)(Math.random()*(iconS.length-1))]);
        senal2.nuevaSenal();
        senal3 = new SenalT(iconS[(int)(Math.random()*(iconS.length-1))]);
        senal3.nuevaSenal();
        puntuacion = 0;
        matrizPreguntas();
    ...
    private void iconosS(){
      iconS = new Image[]{Toolkit.getDefaultToolkit().getImage("data/icons/1.png"),
            Toolkit.getDefaultToolkit().getImage("data/icons/2.png"),
            Toolkit.getDefaultToolkit().getImage("data/icons/3.png"),
            Toolkit.getDefaultToolkit().getImage("data/icons/4.png"),
            Toolkit.getDefaultToolkit().getImage("data/icons/5.png"),
            Toolkit.getDefaultToolkit().getImage("data/icons/6.png"),
            Toolkit.getDefaultToolkit().getImage("data/icons/7.png"),
            Toolkit.getDefaultToolkit().getImage("data/icons/8.png"),
            Toolkit.getDefaultToolkit().getImage("data/icons/9.png"),
            Toolkit.getDefaultToolkit().getImage("data/icons/10.png"),
            Toolkit.getDefaultToolkit().getImage("data/icons/11.png"),
            Toolkit.getDefaultToolkit().getImage("data/icons/12.png"),
            Toolkit.getDefaultToolkit().getImage("data/icons/13.png"),
            Toolkit.getDefaultToolkit().getImage("data/icons/14.png"),
            Toolkit.getDefaultToolkit().getImage("data/icons/15.png")};   
    }
}
