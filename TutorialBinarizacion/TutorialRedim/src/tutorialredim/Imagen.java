 ...
 */
public class Imagen {
    public static final int anchoPermitido=1920;
    public static final int altoPermitido=1920;
    ...
    public BufferedImage redimensionar(String archivo, double porcentaje ){
        ...
        g.setRenderingHint(RenderingHints.KEY_INTERPOLATION,RenderingHints.KEY_FRACTIONALMETRICS);
